...
<html>
    <head>
        ...
        <link href="{{ secure_asset('css/adult2.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <a href="./os" target="_blank"><img src="{{ asset('image/IMG_4779.jpg') }}"></img></a>
        ...
        <a href="./os" target="_blank"><img src="{{ asset('image/IMG_4788.jpg') }}"></img></a>
        ...
        <a href="./os" target="_blank"><img src="{{ asset('image/kokoko-2.jpg') }}"></img></a>
